<%@page import="org.byteandbuild.webapp.model.Cliente"%>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarByteAndBuild">
            <div class="navbar-nav">
                ...
                <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/cliente-servlet">Clientes</a>
        ...
        <div class="card-body">
            <div class="list-group">
                ...
                <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center mb-2 shadow-sm rounded">
                    <div>
                        <h5 class="mb-1"><%= clientes.getNombre() %></h5>
                        <p class="mb-1">Dirección: <%= clientes.getDireccion() %></p>
                        <small>Teléfono: <%= clientes.getTelefono() %></small><br>
                        <small>Correo: <%= clientes.getCorreo() %></small>
                    </div>
