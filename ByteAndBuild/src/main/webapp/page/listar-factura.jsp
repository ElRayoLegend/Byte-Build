<%@page import="org.byteandbuild.webapp.model.Factura"%>
...
<nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand">
            <img src="${pageContext.request.contextPath}/assets/brand/logo-long.svg" alt="Logo" width="170" height="24" class="d-inline-block align-text-center">
        </a>
        ...
        <div class="card-body">
            <div class="list-group">
                ...
                <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center mb-2 shadow-sm rounded">
                    <div>
                        <h5 class="mb-1"><%= factura.getDescripcion() %></h5>
                        <p class="mb-1">Fecha: <%= factura.getFechaFactura() %></p>
                        <small>Monto: <%= factura.getMonto() %></small><br>
                    </div>
