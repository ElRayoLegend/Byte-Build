    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarByteAndBuild">
            <div class="navbar-nav">
                ...
                <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/proveedor-servlet">Proveedores</a>
...
<div class="container mt-5 pt-5">
    <div class="card shadow-lg rounded">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="${pageContext.request.contextPath}/page/agregar-proveedor.jsp" class="btn btn-primary"><i class="bi-plus-lg"></i> Agregar Proveedor</a>
        </div>
        <div class="card-body">
