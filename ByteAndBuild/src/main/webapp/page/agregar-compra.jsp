    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm rounded">
                <div class="card-body">
                    <h2 class="card-title mb-4">Agregar Compra</h2>
                    <form action="${pageContext.request.contextPath}/compra-servlet" method="post">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Descripcion" required>
                            <label for="descripcion">Descripcion</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" id="fechaCompra" name="fechaCompra" placeholder="FechaCompra" required>
                            <label for="fechaCompra">Fecha</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="double" class="form-control" id="total" name="total" placeholder="Total" required>
