...
import org.byteandbuild.byteandbuild.service.CompraService;
...
public class CompraServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        //Este método se llama cuando el servlet se inicializa.
        super.init();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //Redirige a la página JSP para mostrar la lista de compras.
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (pathInfo != null && !pathInfo.equals("/")) {
            //Se divide pathInfo en partes utilizando el carácter "/" como delimitador.
            String[] pathParts = pathInfo.split("/");
            
            //Se verifica que pathParts tenga una longitud de 2, lo que asegura que se haya proporcionado un ID válido
            if (pathParts.length == 2) {
                ...
                se llama al método editarCompra pasando el ID de la compra, 
        ...
        private void eliminarCompra(int compraId, HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            Compra compra = compraService.buscarCompra(compraId);
            //Si la entidad Compra no es nula (es decir, se encontró en la base de datos), se procede a eliminarla.
            if (compra != null) {
                ...
                //Si la compra no se encuentra, se envía un error 404 (Not Found) al cliente.
                resp.sendError(HttpServletResponse.SC_NOT_FOUND);
            }
        }
